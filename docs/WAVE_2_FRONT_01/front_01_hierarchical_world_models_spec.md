...
|---|---|
| [`tolman_eichenbaum_machine_space_relational_memory_2020.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/tolman_eichenbaum_machine_space_relational_memory_2020.pdf) | Entorhinal grid-cell structural basis representations $G$, sensory binding $X \otimes G$, path integration via action transition matrices $g_{t+1} = W_{a_t} g_t$, and relational memory generalization across environments. |
| [`what_is_a_cognitive_map_behrens_2018.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/what_is_a_cognitive_map_behrens_2018.pdf) | Formalizing cognitive maps as relational graphs mapping non-spatial state topologies into structural vector spaces for fast downstream computation and zero-shot inference. |
| [`how_to_build_a_cognitive_map_whittington_2022.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/how_to_build_a_cognitive_map_whittington_2022.pdf) | Higher-order abstraction mechanics in entorhinal-hippocampal networks: transitive inference, compositional structure representation, and structural graph transfer. |
| [`thorough_formalization_of_conceptual_spaces_bechberger_2017.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/thorough_formalization_of_conceptual_spaces_bechberger_2017.pdf) | Mathematical formalization of Gärdenfors conceptual spaces: metric quality dimensions, prototype vectors $\vec{\mu}_k$, Mahalanobis distance metric $d_{\mathbf{M}}$, and Voronoi region boundary equations. |
| [`towards_a_definition_of_disentangled_representations_2018.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/towards_a_definition_of_disentangled_representations_2018.pdf) | Group-theoretic formulation of disentangled representations: quality dimensions as invariant subspace projections under symmetry transformations $g \in G$. |
| [`recurrent_world_models_facilitate_policy_evolution_ha_2018.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/recurrent_world_models_facilitate_policy_evolution_ha_2018.pdf) | Two-phase world model architecture separating spatial state encoding (V-model) from latent temporal dynamics predictions (M-model). |
| [`dreamerv3_mastering_diverse_domains_world_models_2023.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/dreamerv3_mastering_diverse_domains_world_models_2023.pdf) | Multi-scale discrete latent space representation, KL-balancing, and robust world model predictions across heterogeneous domains without hyperparameter tuning. |
| [`discovery_of_structural_form_kemp_tenenbaum_2008.pdf`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/docs/WAVE_2_FRONT_01/papers/discovery_of_structural_form_kemp_tenenbaum_2008.pdf) | Generative structural form discovery (trees, grids, rings, hierarchies, clusters) parsing relational observation matrices into topological graphs. |
...
1. [`hierarchical_types.py`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/src/hypostases/world_model/hierarchical_types.py): Dataclasses for `QualityDimension`, `ConceptualRegion`, `TEMBasis`, `AbstractionLevel`, and `HierarchicalState`.
2. [`conceptual_spaces.py`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/src/hypostases/world_model/conceptual_spaces.py): Gärdenfors Mahalanobis distance calculator, Voronoi tessellation engine, and $O(1)$ gist categorization.
3. [`tem_factorization.py`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/src/hypostases/world_model/tem_factorization.py): TEM structural basis matrix $G$, sensory binding $X \otimes G$, and action transition predictor $W_a$.
4. [`hierarchical_world_model.py`](file:///c:/Users/Leonardo/001/00__DEV/HYPOSTASES/src/hypostases/world_model/hierarchical_world_model.py): Master `HierarchicalWorldModel` engine integrating all 6 abstraction levels into state component $w$.
